...
var (
	...
	ErrNoPendingAuthForm                = E.New("no pending openconnect authentication form")
	ErrAuthFormNotAnswerable            = E.New("openconnect authentication form does not accept a response")
	ErrAuthFormCanceled                 = E.New("openconnect authentication form canceled")
	ErrAuthenticationFailed             = E.New("openconnect authentication failed")
	ErrSessionRejected                  = E.New("openconnect session rejected")
	ErrBrowserAuthenticationUnsupported = E.New("openconnect browser authentication is not supported on this platform")
